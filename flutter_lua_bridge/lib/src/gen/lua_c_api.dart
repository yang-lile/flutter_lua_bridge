...
abstract class LuaCApi {
  ...
  /// Stack: [-0, +0, &ndash;]
  ///
  /// Dumps a function as a binary chunk. Receives a Lua function on the top of the stack and produces a binary chunk that, if loaded again, results in a function equivalent to the one dumped. As it produces parts of the chunk, lua_dump calls function writer (see flb.lua_Writer) with the given data to write them.
  ...
  /// Stack: [-0, +0, &ndash;]
  ///
  /// Creates a new independent state and returns its main thread. Returns NULL if it cannot create the state (due to lack of memory). The argument f is the allocator function; Lua will do all memory allocation for this state through this function (see flb.lua_Alloc). The second argument, ud, is an opaque pointer that Lua passes to the allocator in every call. The third argument, seed, is a seed for the hashing of strings.
  ...
  /// Stack: [-0, +1, m]
  ///
  /// Creates a new thread, pushes it on the stack, and returns a pointer to a flb.lua_State that represents this new thread. The new thread returned by this function shares with the original thread its global environment, but has an independent execution stack.
  ...
  /// Stack: [-0, +0, &ndash;]
  ///
  /// Sets the warning function to be used by Lua to emit warnings (see flb.lua_WarnFunction). The ud parameter sets the value ud passed to the warning function.
  ...
  /// Stack: [-0, +0, &ndash;]
  ///
  /// Converts the Lua value at the given index to the signed integral type flb.lua_Integer. The Lua value must be an integer, or a number or string convertible to an integer (see &sect;3.4.3); otherwise, lua_tointegerx returns 0.
  ...
  /// Stack: [-0, +0, &ndash;]
  ///
  /// Converts the value at the given index to a Lua thread (represented as flb.lua_State*). This value must be a thread; otherwise, the function returns NULL.
