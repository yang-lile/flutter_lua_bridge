...
abstract class LuaAuxApi {
  ...
  /// Stack: [-0, +0, &ndash;]
  ///
  /// This function implements the luaL_opt macro logic: if the argument at index [arg]
  /// is none or nil, returns [dflt]; otherwise calls [fetch] to get the value.
  ///
  /// The [fetch] callback receives the Lua state pointer [L] and the argument index [arg],
  /// and should return a value of type [T].
  ///
  /// Example usage:
  /// ```dart
